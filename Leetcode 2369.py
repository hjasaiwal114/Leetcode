class Solution:
    def validPartition(self, nums: List[int]) -> bool:
        ...
        # If the array has only one element, then not possible to partition into valid suubarrays
        if n == 1:
            return False 
        
        # Initialization for the first values
        ...
        for i in range(2, n):
            ...
            # Check for 3 consecutive increadsing elements
